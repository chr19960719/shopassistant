const langObj = {
    CN: {
        ...
        home_index_fourth:
            '我们拥有丰富的产品线、强大的供应链能力和完善的物流体系，致力于打造高效、便捷的全球电子商务体验，助力您开拓无限商机。',
        ...
        home_fourth_fourth:
            '我希望对我的卧室窗帘进行装饰，我将用它作为我的天花板饰板的金色镶边。这个商品的质量非常优秀，为我的空间增添了美丽的一笔。我强烈推荐这款产品！',
        home_fourth_fifth: '一位来自法国的客户',
        home_fourth_sixth: '愉快',
        home_fourth_seventh:
            '我希望将这些照片挂在圣诞树上 - 我将用丝带替换钥匙圈部分。它们尺寸十分完美，看上去很有质感。包装非常仔细，而且送货速度非常快。购物体验真的很愉快！',
        ...
        about_fifth:
            '自创立以来，本公司秉持团结、创新、诚信、卓越的核心价值观，不断进行内部革新，凭借产品、服务、海外仓、自有品牌等方面优势，拥有了成熟的生产、仓储、营销、物流及售后体系。',
        about_sixth: '博锐布莱恩贸易私人有限公司正在不断加快和加强国际市场的布局，致力于让我们的产品走进每个家庭，让生活变得更便捷!',
        about_seventh: '海外子公司',
        about_eighth: '自有仓库',
        about_ninth: '在职员工',
        about_tenth: '产品数量',
    ...
    EN: {
        ...
        msg_second: '',
        msg_third: 'Welcome to explore our trading services.',
        msg_fourth: 'You can contact us for more information',
        msg_fifth: 'and dedicated customer service.',
        ...
        home_index_fourth:
            'We have various product lines, the strong supply chain and a well-established logistics system, and always are dedicated to creating an efficient and convenient global e-commerce experience, helping you capture more business opportunities.',
        ...
        home_fourth_fourth:
            'I am looking to decorate my bedroom curtains and I will use them as gold trim for my ceiling panels. The quality of this item is excellent and it makes a beautiful addition to my space. I highly recommend this product!',
        home_fourth_fifth: 'A customer from France',
        home_fourth_sixth: 'Joy',
        home_fourth_seventh:
            "I'm hoping to hang these photos on my Christmas tree - I'll be replacing the keychain part with ribbon. They are the perfect size and look great. The packaging was very careful and the delivery was very fast. The shopping experience is really enjoyable!",
        ...
        about_fourteenth:
            'Our main private brand ISIYINER  has been exported to Eurpoe, Southeast Asia etc, and gains lots of good feedback from Amazon, Shopee and Alibaba,  with 99% highly rating. Besides, we also have other different brands focusing on each unique market segment.',
        about_fifteenth: 'Our Team',
        about_sixteenth:
            'Our sales team consists of more than ** professional sales people,  including  **%   overseas local employees. Our members are experienced and professional, also with good knowledge about local markets. They have excellent communication skill and outstanding ability of cooperating with customers and partners to achieve various requirements from different market. ',
